...
class Comment extends \AppBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'enabled', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'video', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'user');
        }
    ...
    public function getContentclear()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContentclear', array());
