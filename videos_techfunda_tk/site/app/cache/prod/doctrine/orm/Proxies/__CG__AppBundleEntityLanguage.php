...
class Language extends \AppBundle\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'language', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'enabled', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\Language' . "\0" . 'media');
        }
