...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'videos', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'media');
        }
