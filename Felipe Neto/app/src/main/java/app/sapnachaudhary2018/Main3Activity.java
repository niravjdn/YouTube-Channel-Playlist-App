...
public class Main3Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* TabModel m = new TabModel("demo","dafEMk2A6QKz1mrk1uIGfHkC1zZ6UU","playlist");
        ...
        TabModel.tabnameList = TabModel.tabnameList3;
        TabModel.playlistOrChannelList = TabModel.playlistOrChannelList3;
        TabModel.idRegardingyoutubeList = TabModel.idRegardingyoutubeList3;
        ...
        try{
            navigationView.getMenu().findItem(R.id.nav_channel3).setChecked(true);
        }catch (Exception e){
