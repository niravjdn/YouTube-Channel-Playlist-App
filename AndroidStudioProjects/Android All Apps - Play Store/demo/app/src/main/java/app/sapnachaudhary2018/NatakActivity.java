...
import app.sapnachaudhary2018.adapters.PagerAdapterNatak;
...
public class NatakActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  AdRequest adRequest = new AdRequest.Builder().addTestDevice(getString(R.string.testdevice))
       ...
       /* TabModel m = new TabModel("demo","dafEMk2A6QKz1mrk1uIGfHkC1zZ6UU","playlist");
        ...
        for(int i = 0; i< TabModel.natakIdRegardingyoutubeList.size(); i++){
            Log.d("App: sizeoflist",TabModel.natakIdRegardingyoutubeList.size()+"");
            tabLayout.addTab(tabLayout.newTab().setText(TabModel.natakTabnameList.get(i)));
        }
        ...
        final PagerAdapterNatak adapter = new app.sapnachaudhary2018.adapters.PagerAdapterNatak(getSupportFragmentManager(),tabLayout.getTabCount());
        ...
        try{
            navigationView.getMenu().findItem(R.id.nav_natak).setChecked(true);
        }catch (Exception e){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // getMenuInflater().inflate(R.menu.Natak, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent i = new Intent(NatakActivity.this, MainActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_natak) {
            // Handle the home action
            if(!item.isChecked()){
                Intent i = new Intent(NatakActivity.this, NatakActivity.class);
                startActivity(i);
            }
        }else if (id == R.id.nav_bhajan) {
            // Handle the home action
            Intent i = new Intent(NatakActivity.this, BhajanActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_speech) {
            // Handle the home action
            Intent i = new Intent(NatakActivity.this, SpeechActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_garba) {
            // Handle the home action
            Intent i = new Intent(NatakActivity.this, GarbaActivity.class);
            startActivity(i);
            finish();
            ...
            alertDialogBuilder
                    .setMessage("The content provided in this app is hosted by YouTube and is available in " +
                            "public doNatak. We do not upload any videos to YouTube and don't even show any modified content. " +
