...
public class TabModel {
    public static List<String> tabnameList = Arrays.asList(
            "Latest","Top 10","Popular");
    public static List<String> idRegardingyoutubeList = Arrays.asList("UCuB112ZHY1iygcDEHRg6P5Q","PLlT5Mh7LdcLZk2MB6LiUbZ2YbJQbj3mZv","PLP-nGFpz3fa_0O0nN4kMLbZ6V_equSZLN");
