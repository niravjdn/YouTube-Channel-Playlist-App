        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-3"></div>
                  <div class="col-lg-6">
                    <form action="thumbnail_process.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                      <div class="card-header">
                        <strong>Add new</strong> video
                      </div>
                      ...
                      <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image" class="form-control" required="" id="image" onchange="uploadFile()">
                            </div>
