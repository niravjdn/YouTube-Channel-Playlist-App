package freaktemplate.videostatus.ObservableLayer;
...
import static freaktemplate.videostatus.activity.HomeActivity.changeLoad;
import static freaktemplate.videostatus.adapter.CustomVideoListAdapter.setLoaded;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, hp,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Log.e("Dekho HVModel Response", response);
