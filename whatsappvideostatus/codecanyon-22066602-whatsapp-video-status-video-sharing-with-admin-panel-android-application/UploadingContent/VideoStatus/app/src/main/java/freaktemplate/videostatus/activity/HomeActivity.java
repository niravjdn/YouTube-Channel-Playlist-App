...
import freaktemplate.videostatus.ObservableLayer.HomeVideoViewModel;
import freaktemplate.videostatus.adapter.CustomHorizontalAdapter;
import freaktemplate.videostatus.adapter.CustomNavigationBarAdapter;
import freaktemplate.videostatus.adapter.CustomVideoListAdapter;
import freaktemplate.videostatus.getSet.categoryGetSet;
import freaktemplate.videostatus.getSet.menuGetSet;
import freaktemplate.videostatus.getSet.videoListGetSet;
import freaktemplate.videostatus.R;
import freaktemplate.videostatus.onClickListners.OnLoadListeners;
import freaktemplate.videostatus.onClickListners.onCategoryListClick;
import freaktemplate.videostatus.onClickListners.onVideoListClick;
import freaktemplate.videostatus.utilities.AdManager;
import freaktemplate.videostatus.utilities.Config;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, hp,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        //hiding the progressbar after completion
                        //    progressBar.setVisibility(View.GONE);
                        Log.e("Dekho Increase Response", response);
