...
public class TabModel {
    public static List<String> tabnameList = Arrays.asList(
            "Amit Bhadana","LShokeen","RealSHIT","Elvish Yadav","HUNNY SHARMA","Awanish Singh","Half Engineer");
    public static List<String> idRegardingyoutubeList = Arrays.asList("UC_vcKmg67vjMP7ciLnSxSHQ","UCsLOXfgwzeLAl9E-6Flu3Bg","UCsSZyyGKf9FdpqDmynjVBcA","UCbmu9wfzxKls40WkCzvqtRA","UCrZAk8NGdX_poApOHyhKjzA","UCPTw_UvDWKCYtWfZQAOi7pg","UCNLGvPguokaRr6TgMgP1txg");
    public static List<String> playlistOrChannelList = Arrays.asList("channel","channel","channel","channel","channel","channel","channel");
