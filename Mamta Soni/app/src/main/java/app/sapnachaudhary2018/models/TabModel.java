...
public class TabModel {
    public static List<String> tabnameList = Arrays.asList(
            "Movies","Shayri");
    public static List<String> idRegardingyoutubeList = Arrays.asList("PL_mlupJ4yJIhZ4Ju6eNd7xOzYXueHtSqU","PL_mlupJ4yJIi3ALwt-8PgDTKX0ZrrGw29");
    public static List<String> playlistOrChannelList = Arrays.asList("playlist","playlist");
