...
public class Main2Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //copy list change here
        TabModel.tabnameList = TabModel.tabnameList2;
        TabModel.playlistOrChannelList = TabModel.playlistOrChannelList2;
        TabModel.idRegardingyoutubeList = TabModel.idRegardingyoutubeList2;
        ...
        try{
            navigationView.getMenu().findItem(R.id.nav_channel2).setChecked(true);
        }catch (Exception e){
