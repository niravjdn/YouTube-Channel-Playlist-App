...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            // Handle the home action
            Intent i = new Intent(MainActivity.this, NatakActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_bhajan) {
            // Handle the home action
            Intent i = new Intent(MainActivity.this, BhajanActivity.class);
            startActivity(i);
            finish();
            ...
            // Handle the home action
            Intent i = new Intent(MainActivity.this, GarbaActivity.class);
            startActivity(i);
            finish();
