...
public class TabModel {
    public static List<String> tabnameList = Arrays.asList(
            "2018","2017","Live","Aarti");
    public static List<String> idRegardingyoutubeList = Arrays.asList("PL_mlupJ4yJIhWuFTyRMALg_8NnpIoYUZ-","PL_mlupJ4yJIhu5v6VQjrDcSSRxfys0Zdr","PL_mlupJ4yJIiBS5-xvhA9r1rMN_Hmmph9","PL_mlupJ4yJIjWWSEeebQqcCQJOPEHtfLw");
    public static List<String> playlistOrChannelList = Arrays.asList("playlist","playlist","playlist","playlist");
