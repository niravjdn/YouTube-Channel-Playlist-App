...
public class TabModel {
    public static List<String> tabnameList = Arrays.asList(
            "2018","2017","Item Songs");
    public static List<String> idRegardingyoutubeList = Arrays.asList("PL_mlupJ4yJIhI5X2jo-sK-wgDYYE-wKCy","PL_mlupJ4yJIibXcoTiXIY0_x_2KN8p4r_","PL_mlupJ4yJIhCKOVIrA9SSyzwF8Y8p7-v");
    public static List<String> playlistOrChannelList = Arrays.asList("playlist","playlist","playlist");
