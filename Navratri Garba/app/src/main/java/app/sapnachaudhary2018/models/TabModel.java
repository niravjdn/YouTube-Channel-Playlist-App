...
public class TabModel {
    public static List<String> tabnameList = Arrays.asList(
            "Kinjal Dave","Geeta Rabari","Jignesh Kaviraj","Sagar Patel","Alpa Patel","Other");
    public static List<String> idRegardingyoutubeList = Arrays.asList("PL_mlupJ4yJIiZNDf8H268PEc9zxR6eYlr","PL_mlupJ4yJIiZCWv8J2O9mxKMSC4Dr49w","PL_mlupJ4yJIijITMwsA0jro_FxXQP38Mw","PL_mlupJ4yJIhHeBqw0N-8VXsDxCFtf2n4","PL_mlupJ4yJIgOAuA4yhlrXXTJKNKagF2o","PL_mlupJ4yJIgsoVG4Sb9SEFiva7NBz70R");
    public static List<String> playlistOrChannelList = Arrays.asList("playlist","playlist","playlist","playlist","playlist","playlist");
