...
public class BhajanActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* TabModel m = new TabModel("demo","dafEMk2A6QKz1mrk1uIGfHkC1zZ6UU","playlist");
        ...
        for(int i = 0; i< TabModel.bhajanIdRegardingyoutubeList.size(); i++){
            Log.d("App: sizeoflist",TabModel.bhajanIdRegardingyoutubeList.size()+"");
            tabLayout.addTab(tabLayout.newTab().setText(TabModel.bhajanTabnameList.get(i)));
        }
        ...
        final PagerAdapterBhajan adapter = new app.sapnachaudhary2018.adapters.PagerAdapterBhajan(getSupportFragmentManager(),tabLayout.getTabCount());
        ...
        try{
            navigationView.getMenu().findItem(R.id.nav_bhajan).setChecked(true);
        }catch (Exception e){
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent i = new Intent(BhajanActivity.this, MainActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_natak) {
            // Handle the home action
            Intent i = new Intent(BhajanActivity.this, NatakActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_bhajan) {
            // Handle the home action
            if(!item.isChecked()){
                Intent i = new Intent(BhajanActivity.this, BhajanActivity.class);
                startActivity(i);
            }
        }else if (id == R.id.nav_speech) {
            // Handle the home action
            Intent i = new Intent(BhajanActivity.this, SpeechActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_garba) {
            // Handle the home action
            Intent i = new Intent(BhajanActivity.this, GarbaActivity.class);
            startActivity(i);
            finish();
