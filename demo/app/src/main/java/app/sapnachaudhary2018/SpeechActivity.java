...
import app.sapnachaudhary2018.adapters.PagerAdapterSpeech;
...
public class SpeechActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* TabModel m = new TabModel("demo","dafEMk2A6QKz1mrk1uIGfHkC1zZ6UU","playlist");
        ...
        for(int i = 0; i< TabModel.speechIdRegardingyoutubeList.size(); i++){
            Log.d("App: sizeoflist",TabModel.speechIdRegardingyoutubeList.size()+"");
            tabLayout.addTab(tabLayout.newTab().setText(TabModel.speechtabnameList.get(i)));
        }
        ...
        final PagerAdapterSpeech adapter = new app.sapnachaudhary2018.adapters.PagerAdapterSpeech(getSupportFragmentManager(),tabLayout.getTabCount());
        ...
        try{
            navigationView.getMenu().findItem(R.id.nav_speech).setChecked(true);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            // Handle the home action
            Intent i = new Intent(SpeechActivity.this, NatakActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_bhajan) {
            // Handle the home action
            Intent i = new Intent(SpeechActivity.this, BhajanActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_speech) {
            // Handle the home action
            if(!item.isChecked()){
                Intent i = new Intent(SpeechActivity.this, SpeechActivity.class);
                startActivity(i);
            }
            ...
            // Handle the home action
            Intent i = new Intent(SpeechActivity.this, GarbaActivity.class);
            startActivity(i);
            finish();
            ...
            alertDialogBuilder
                    .setMessage("The content provided in this app is hosted by YouTube and is available in " +
                            "public doSpeech. We do not upload any videos to YouTube and don't even show any modified content. " +
