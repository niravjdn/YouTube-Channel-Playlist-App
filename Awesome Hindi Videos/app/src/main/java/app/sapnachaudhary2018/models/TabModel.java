...
public class TabModel {
    ...
    public static List<String> idRegardingyoutubeList = Arrays.asList("UCzUcMOXkza4GxKG0pbl-jDQ");
    public static List<String> playlistOrChannelList = Arrays.asList("channel");
