...
public class TabModel {
    public static List<String> tabnameList = Arrays.asList(
            "Amit Bhadana", "BB Ki Vines" , "Harsh Beniwal" ,"LShokeen", "Be YouNick" , "Ashish Chanchlani" , "CarryMinati" ,"RealSHIT","Elvish Yadav","HUNNY SHARMA","Awanish Singh","Half Engineer");
    public static List<String> idRegardingyoutubeList = Arrays.asList("UC_vcKmg67vjMP7ciLnSxSHQ", "UCqwUrj10mAEsqezcItqvwEw" , "UCVmEbEQUGXHVm-O9pqa3JWg" ,"UCsLOXfgwzeLAl9E-6Flu3Bg", "UC7sRFTKIbH4NNpFXmpUAWuA" , "UC7eHZXheF8nVOfwB2PEslMw", "UCj22tfcQrWG7EMEKS0qLeEg" ,"UCsSZyyGKf9FdpqDmynjVBcA","UCbmu9wfzxKls40WkCzvqtRA","UCrZAk8NGdX_poApOHyhKjzA","UCPTw_UvDWKCYtWfZQAOi7pg","UCNLGvPguokaRr6TgMgP1txg");
    public static List<String> playlistOrChannelList = Arrays.asList("channel","channel", "channel","channel", "channel", "channel", "channel","channel","channel","channel","channel", "channel");
